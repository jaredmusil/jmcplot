...
#' Arrange alignment and save JMC ggplot chart
#'
#' Running this function will save your plot with the correct guidelines for publication for a JMC News graphic.
#' It will left align your title, subtitle and source, add the JMC blocks at the bottom right and save it to your specified location.
...
#'  which needs to be a PNG file - defaults to JMC blocks image that sits within the data folder of your package
...
finalise_plot <- function(
  ...
  width_pixels=640,
  height_pixels=450,
  logo_image_path = file.path(system.file("data", package = 'jmcplot'),"placeholder.png")) {
